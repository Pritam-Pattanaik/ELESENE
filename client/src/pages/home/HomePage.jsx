...
const ScrollingTextSection = () => {
  ...
  const marqueeItems = [
    ...
    { type: 'text', text: 'NOW', italic: true },
    { type: 'image', url: 'https://images.unsplash.com/photo-1581044777550-4cfa60707c03?q=80&w=600&auto=format&fit=crop', tag: 'RESORT GOWN', slug: 'chiffon-resort-gown' },
    { type: 'text', text: 'TRENDING', italic: false },
    { type: 'image', url: 'https://images.unsplash.com/photo-1485968579580-b6d095142e6e?q=80&w=600&auto=format&fit=crop', tag: 'VELVET GOWN', slug: 'velvet-evening-gown' },
    { type: 'text', text: 'NOW', italic: true },
    { type: 'image', url: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=600&auto=format&fit=crop', tag: 'LEATHER BAG', slug: 'monogram-leather-bag' },
    { type: 'text', text: 'TRENDING', italic: false },
    { type: 'image', url: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?q=80&w=600&auto=format&fit=crop', tag: 'SILK SLIP', slug: 'silk-slip-dress' },
    { type: 'text', text: 'NOW', italic: true },
    { type: 'image', url: 'https://images.unsplash.com/photo-1509319117193-57bab727e09d?q=80&w=600&auto=format&fit=crop', tag: 'TAILORED SUIT', slug: 'noir-tailored-suit' },
  ];
